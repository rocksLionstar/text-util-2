            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0" >
              ...
              <li className="nav-item" >
                ...
                {/* </form> */}
                  ...
                  <label className="form-check-label" htmlFor="flexSwitchCheckDefault" noaction="">Enable DarkMode</label>
                  </div>
           </div>
         </div>
      </nav>
...
// Navbar.defaultprops ={title: 'message-app',
//                        About: 'now-about-msg-app'};